...
@Component({
    ...
    template: `
        <sb-layout-dashboard>
            <sb-dashboard-head title="Nueva Unidad de medida" [hideBreadcrumbs]="false"></sb-dashboard-head>
            <sb-card>
                <div class="card-body">
                    ...
                    <div class="form-group col-md-12 text-right">
                        ...
                        <button class="btn btn-primary btn-sm" [disabled]="measureUnitForm.invalid" (click)="onSave()">
                            <i
                                class="fa fa-plus-square-o"></i> <span
    ...
    public onSave(): void {
        if (this.measureUnitForm.valid) {
            this.confirmDialogService.confirmSave().then(() => {
                this.measureUnitService.add$(this.measureUnitForm.value).subscribe(response => {
                    if (response) {
                        this.onBack();
                    }
                }, error => {
